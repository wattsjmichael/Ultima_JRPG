...
public class BattleChar : MonoBehaviour
{
    ...
    public string[] movesAvailable; //name of moves
    ...
    void Update()
    {
        if (shouldFade)
        {
            theSprite.color = new Color(
                Mathf.MoveTowards(theSprite.color.r, .57f, fadeSpeed * Time.deltaTime),
                Mathf.MoveTowards(theSprite.color.g, 0f, fadeSpeed * Time.deltaTime),
                Mathf.MoveTowards(theSprite.color.b, .79f, fadeSpeed * Time.deltaTime),
